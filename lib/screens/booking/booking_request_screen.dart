...
class _BookingRequestScreenState extends State<BookingRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Solicitud de cita"),
            ...
            children: [
              ...
              IgnorePointer(
                child: TableCalendar(
                  ...
                  focusedDay: widget.booking.date,

                  selectedDayPredicate: (day) {
                    return isSameDay(day, widget.booking.date);
                  },
              ...
              if (widget.booking.status == "Pendiente")
                Row(
                  children: [
                    Expanded(child: Text("Aqui iba un boton")),
                    ...
                    Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: widget.booking.status == "Aceptada"
                              ? Colors.green
                              : Colors.red,
                        ),
                      ),
