...
class _AddChildBottomSheetState extends State<AddChildBottomSheet> {
  ...
  List<String> _selectedNeeds = <String>['Mascotas'];
  ...
  Widget build(BuildContext context) {
    ...
    const softPurpleLight = Color(0xFFCBA1BD); // Tono suavizado/pastel para fondos
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Text(
                'Agregar niño',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: customPurple),
              ),
              IconButton(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Nombre del niño', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.person_outline, color: customPurple),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(15),
                        borderSide: const BorderSide(color: customPurple, width: 2),
                      ),
                  ...
                  const Text('Edad del niño', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    runSpacing: 4,
                    children: _ageRanges.map((age) {
                      ...
                      return ChoiceChip(
                        ...
                        onSelected: (selected) => setState(() => _selectedAgeRange = selected ? age : ''),
                      );
                    }).toList(),
                  ),
                  ...
                  const SizedBox(height: 20),
                  const Text('Niñera cómoda con', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    runSpacing: 4,
                  ...
                  const SizedBox(height: 20),
                  const Text('Preferencia del lugar', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    children: _placesOptions.map((place) {
                      ...
                      return ChoiceChip(
                        ...
                        onSelected: (selected) => setState(() => _selectedPlace = selected ? place : ''),
                      );
                    }).toList(),
                  ),
                  ...
                  const SizedBox(height: 20),
                  const Text('Cuándo necesitamos a la niñera', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    ...
                    children: [
                      ...
                      TableRow(
                        decoration: BoxDecoration(
                          color: softPurpleLight.withValues(alpha: 0.15), // Un sutil fondo pastel
                        ),
                        children: [
                          ...
                          children: [
                            ...
                            ...List.generate(7, (colIndex) {
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    _schedule[rowIndex][colIndex] = !_schedule[rowIndex][colIndex];
                                  });
                                },
                                child: Container(
                                  ...
                                  child: Icon(
                                    ...
                                    color: _schedule[rowIndex][colIndex] ? customPurple : Colors.grey.shade400,
                                    size: 22,
                                  ),
                                ),
                              );
