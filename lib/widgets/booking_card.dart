...
class BookingCard extends StatelessWidget {
  ...
  final bool
  isCaregiver; // controla si muestra foto/nombre del tutor o caregiver
  final Widget? trailing; // botones extra opcionales
  ...
  Widget build(BuildContext context) {
    final photoUrl = isCaregiver ? booking.caregiverPhoto : '';
    final name = isCaregiver ? booking.caregiverName : booking.tutorName;
